...
var christmasPresent = new Box('exists', false);
...
var snake = new Animal('thing', 'male');
var notWarmOrColdAnimal = snake.isWarmBlooded();
...
var polygon = new Shape(15).getType();
 ...
 *
 */
var farTooTallAStory = new House(18).isATallStory(15);
...
var cookieMonsterBlocked = new Cookie('gingerbread').swipedByCookieMonster('Saturday');
